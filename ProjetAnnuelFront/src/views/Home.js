...
// import Background from '../images/accueil.jpg';
...
export default function Home() {
    ...
    return (
        <Grid container>
            <Grid container-fluid className="imageaccueil">
            ...
            <Grid container spacing={4} className='textcenter'>
                <Grid item xs={4}>
                    <ColorButton variant="contained" size="large" className='textcenter'>Demander une visite à domicile</ColorButton>
                </Grid>
                <Grid item xs={4}>
                    <ColorButton variant="contained" size="large" className='textcenter'>Demander une consultation par téléphone</ColorButton>
                </Grid>
                <Grid item xs={4}>
                    <ColorButton variant="contained" size="large" className='textcenter'>Besoin de vous confier ?</ColorButton>
                </Grid>
            </Grid>
            <Grid container spacing={3}>
                <div className='textaccueil'>
                    <h3 className="toto"> SOS MÉDECINS GRAND PARIS :</h3>
            ...
            <Grid container spacing={4} className="colorgray">
                <Grid item xs={6} md={5}>
                    <img src={BabyImage} alt="baby" className='imagebaby' />
                ...
                <Grid item xs={6} md={7}>
                    ...
                    <ColorButton variant="contained" size="large" className='textcenter'>Je dépose ma candidature</ColorButton>
                </Grid>
